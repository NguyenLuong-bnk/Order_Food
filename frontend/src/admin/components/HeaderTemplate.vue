<template>
    <div class="header">
        ...
        <nav class="navbar">
            ...
            <router-link @click="scrollToTop()" to="/promotions">Voucher</router-link>
            <router-link @click="scrollToTop()" to="/menu">Menu</router-link>
            <router-link @click="scrollToTop()" to="/table">Book</router-link>
        </nav>
        ...
        <div class="icons">
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/myorder">Đơn hàng của tôi</router-link>
                    </li>
                    <li>
