            ...
            <form id="checkoutForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group details-group">
                    ...
                    <div v-if="checkoutObj.paymentMethod == 'card'">
                        ...
                        <div class="form-group">
                            <input v-upcase type="text" name="coCardName" placeholder="Nhập tên chủ tài khoản "
                        ...
                        <div class="form-group">
                            <div class="form-control">
                                <span
                                    style="font-size: 1.6rem; position: absolute; margin-left: -5px; margin-top: -11px;">Ngày hết hạn
                                    :
                                </span>
                                <input
                ...
                <div v-if="user" class="form-group">
                    <input type="submit" value="Xác nhận và thanh toán" class="btn"
