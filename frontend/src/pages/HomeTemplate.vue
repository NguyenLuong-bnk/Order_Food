    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Ẩm thực Việt 😋</h3>
                <p>Chúng Tôi Cam Kết Sử Dụng Thực Phẩm Tươi Sống Với Chất Lượng Tốt Nhất. Thực Khách Sẽ Thưởng Thức Ẩm Thực Mexico Với Hương Vị Bùng Nổ, Tinh Tế..</p>
        ...
        <div class="home-about">
            ...
            <div class="content">
                <span>Lý do nên lựa chọn QFood?</span>
                <h3 class="title">Điều Gì Làm Cho Món Ăn Của Chúng Tôi Trở Nên Nổi Bật!</h3>
                <p>hực Phẩm Đến Tay Khách Hàng Luôn Được Đảm Bảo Chất Lượng Tốt Nhất. Các Món Ăn Do Chef Quang (Đầu Bếp 5 Sao Michelin) Thực Hiện, Hứa Hẹn Mang Đến Hương Vị Bùng Nổ, Tinh Tế, Ấn Tượng. Dịch Vụ Giao Hàng Tận Nơi Của Chúng Tôi Rất Chuyên Nghiệp, Khách Hàng Có Thể Thưởng Thức Chất Lượng Như Tại Nhà Hàng</p>
